import{j as e}from"./i18n.B2AVHcGw.js";import{R as P,r as c}from"./index.Dkaqzkgy.js";import{r as f,u as g}from"./useTranslations.DYC37lO_.js";import{I as u,r as F,c as L,a as I,t as $,L as w,g as A,b as z,T as D,d as K,e as O,f as B}from"./radio.Bb9wCwEh.js";class J extends P.Component{constructor(t){super(t),this.state={hasError:!1}}static getDerivedStateFromError(){return{hasError:!0}}componentDidCatch(t,n){typeof window<"u"&&window.Sentry&&window.Sentry.captureException(t,{contexts:{react:{componentStack:n.componentStack}}})}render(){return this.state.hasError?this.props.fallback??e.jsxs("div",{style:{padding:"2rem",textAlign:"center",color:"#5b6072"},children:[e.jsx("p",{style:{fontWeight:600,color:"#dc2626",marginBottom:"0.5rem"},children:"Something went wrong."}),e.jsx("p",{style:{fontSize:"0.875rem"},children:"Please refresh the page or try again later."})]}):this.props.children}}const h={en:{time:"Time",calculator:"Calculator",image:"Image",radio:"Radio",dev:"Dev",soon:"soon",new:"New",menu:"Menu",close_menu:"Close menu",tagline:"Open. Use. Done.",contact:"Contact",network:"Moosti",privacy:"Privacy",terms:"Terms"},pt:{time:"Tempo",calculator:"Calculadora",image:"Imagem",radio:"Rádio",dev:"Dev",soon:"em breve",new:"Novo",menu:"Menu",close_menu:"Fechar menu",tagline:"Abra. Use. Pronto.",contact:"Contato",network:"Moosti",privacy:"Privacidade",terms:"Termos"},fr:{time:"Temps",calculator:"Calculatrice",image:"Image",radio:"Radio",dev:"Dev",soon:"bientôt",new:"Nouveau",menu:"Menu",close_menu:"Fermer le menu",tagline:"Ouvrez. Utilisez. Terminé.",contact:"Contact",network:"Moosti",privacy:"Confidentialité",terms:"Conditions"},es:{time:"Tiempo",calculator:"Calculadora",image:"Imagen",radio:"Radio",dev:"Dev",soon:"pronto",new:"Nuevo",menu:"Menú",close_menu:"Cerrar menú",tagline:"Abre. Usa. Listo.",contact:"Contacto",network:"Moosti",privacy:"Privacidad",terms:"Términos"},ru:{time:"Время",calculator:"Калькулятор",image:"Изображение",radio:"Радио",dev:"Dev",soon:"скоро",new:"Новое",menu:"Меню",close_menu:"Закрыть меню",tagline:"Открой. Используй. Готово.",contact:"Контакт",network:"Moosti",privacy:"Конфиденциальность",terms:"Условия"},zh:{time:"时间",calculator:"计算器",image:"图像",radio:"电台",dev:"开发",soon:"即将推出",new:"新",menu:"菜单",close_menu:"关闭菜单",tagline:"打开。使用。完成。",contact:"联系我们",network:"Moosti",privacy:"隐私政策",terms:"服务条款"},ja:{time:"時間",calculator:"計算機",image:"画像",radio:"ラジオ",dev:"開発ツール",soon:"近日公開",new:"新着",menu:"メニュー",close_menu:"メニューを閉じる",tagline:"開く。使う。完了。",contact:"お問い合わせ",network:"Moosti",privacy:"プライバシー",terms:"利用規約"}};f("nav",h);function Z({contexts:r}){const t=g("nav");return e.jsxs("nav",{className:"nav-contexts","aria-label":t("menu","Menu"),children:[r.map(n=>{const s=t(n.slug,n.slug),i={"--ctx":n.accent,"--ctx-soft":n.accentSoft};return n.available?e.jsx("a",{href:n.href,className:`nav-link${n.active?" active":""}`,style:i,"aria-current":n.active?"page":void 0,children:e.jsx("span",{className:"nav-link-label",children:s})},n.slug):e.jsx("span",{className:"nav-link nav-link-soon",style:i,title:t("soon"),"aria-disabled":"true",children:e.jsx("span",{className:"nav-link-label",children:s})},n.slug)}),e.jsx("style",{children:`
      ...
      `})]})}f("nav",h);function ee({contexts:r}){const t=g("nav"),[n,s]=c.useState(!1),i=c.useRef(null),m=c.useId();return c.useEffect(()=>{if(!n)return;const a=l=>{i.current&&!i.current.contains(l.target)&&s(!1)},d=l=>{l.key==="Escape"&&s(!1)};return document.addEventListener("mousedown",a),document.addEventListener("keydown",d),()=>{document.removeEventListener("mousedown",a),document.removeEventListener("keydown",d)}},[n]),c.useEffect(()=>{const a=window.matchMedia("(min-width: 768px)"),d=()=>{a.matches&&s(!1)};return a.addEventListener("change",d),()=>a.removeEventListener("change",d)},[]),e.jsxs("div",{className:"nav-mobile-menu",ref:i,children:[e.jsx("button",{type:"button",className:"nav-menu-btn","aria-expanded":n,"aria-controls":m,"aria-label":n?t("close_menu","Close menu"):t("menu","Menu"),onClick:()=>s(a=>!a),children:e.jsx(u,{name:n?"X":"Menu",size:20})}),n&&e.jsx("nav",{id:m,className:"nav-mobile-panel","aria-label":t("menu","Menu"),children:r.map(a=>{const d=t(a.slug,a.slug),l={"--ctx":a.accent,"--ctx-soft":a.accentSoft};return a.available?e.jsx("a",{href:a.href,className:`nav-mobile-link${a.active?" is-active":""}`,style:l,"aria-current":a.active?"page":void 0,onClick:()=>s(!1),children:d},a.slug):e.jsx("span",{className:"nav-mobile-link is-soon",style:l,"aria-disabled":"true",children:d},a.slug)})}),e.jsx("style",{children:`
        .nav-mobile-menu {
          position: relative;
          display: flex;
          align-items: center;
      ...
      `})]})}f("nav",h);function ae({contexts:r,hubUrl:t,year:n}){const s=g("nav");return e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"ft-inner container",children:[e.jsxs("div",{children:[e.jsx("strong",{children:"Moosti"}),e.jsx("p",{className:"ft-muted",children:s("tagline")}),e.jsx("a",{className:"ft-contact",href:"mailto:talk@moosti.com",children:"talk@moosti.com"})]}),e.jsxs("div",{className:"ft-cols",children:[e.jsx("div",{children:e.jsx("ul",{className:"ft-list",children:r.map(i=>e.jsx("li",{children:i.available?e.jsx("a",{href:i.href,children:s(i.slug,i.slug)}):e.jsxs("span",{className:"ft-soon",children:[s(i.slug,i.slug)," ",e.jsxs("em",{children:["· ",s("soon")]})]})},i.slug))})}),e.jsx("div",{children:e.jsxs("ul",{className:"ft-list",children:[e.jsx("li",{children:e.jsx("a",{href:`${t}/privacy`,children:s("privacy")})}),e.jsx("li",{children:e.jsx("a",{href:`${t}/terms`,children:s("terms")})})]})})]})]}),e.jsxs("div",{className:"ft-copyright container",children:["© ",n," ",e.jsx("a",{href:"https://www.erickjung.com",target:"_blank",rel:"noopener noreferrer",children:"E7G"})]}),e.jsx("style",{children:`
        ...
        .ft-copyright a { color: inherit; text-decoration: none; }
        .ft-copyright a:hover { color: var(--brand-600); text-decoration: underline; }
      `})]})}f("radio",F);const G="#4338ca",U="#eef2ff";function X(){const r=A(),[t,n]=c.useState(null),[s,i]=c.useState(!1),[m,a]=c.useState(null),[d,l]=c.useState(!1);return c.useEffect(()=>(r.hydrateFromPrefs(),n(r.getSelection()),i(r.isPlaying()),a(r.getPlaylist()),l(!0),r.subscribe(()=>{n(r.getSelection()),i(r.isPlaying()),a(r.getPlaylist())})),[r]),{engine:r,selection:t,playing:s,playlist:m,hydrated:d}}function H(r,t){const n=O(r);if(n.length!==0)return n.map(s=>C(s,t)).join(" · ")}function Y(r,t){return r.titleKey?t(r.titleKey,r.title):r.title}function C(r,t){const n=D[r];return t(n.labelKey,t(`lobby.${r}`,r))}function oe(){const r=g("radio"),{engine:t,selection:n,playing:s,playlist:i,hydrated:m}=X(),[a,d]=c.useState("lofi"),[l,y]=c.useState([]);c.useEffect(()=>{i&&(d(L(i)),(i==="guided"||i==="motivational"||i==="study"||i==="concentration")&&y([i]))},[i]);const k=c.useMemo(()=>I(a),[a]),x=c.useMemo(()=>$(a,l),[a,l]),j=w.find(o=>o.id===a)??w[0],E=o=>r("tracks_count").replace("{n}",String(o)),S=o=>{d(o),y([])},T=o=>{y(b=>{const p=b.includes(o)?b.filter(v=>v!==o):[...b,o];return z("lobby",a,p,o),p})},M=()=>{y([]),z("lobby",a,[])},_=async()=>{m&&(K(a,"lobby",{trackCount:x.length,filters:l}),await t.playQueue(x.map(o=>o.id),!0,a))},R=async o=>{m&&(B(o,"lobby",a),await t.select(o,!0))};return e.jsxs("div",{className:"radio-lobby",style:{"--rl-accent":G,"--rl-soft":U},children:[e.jsxs("header",{className:"radio-lobby-hero",children:[e.jsx("h1",{className:"radio-lobby-brand",children:r("lobby_title")}),e.jsx("p",{className:"radio-lobby-lede",children:r("lobby_lede")})]}),e.jsx("section",{className:"radio-lobby-section","aria-label":r("tab_lobby"),children:e.jsx("div",{className:"radio-lobby-playlists",children:w.map(o=>{const b=a===o.id;return e.jsxs("button",{type:"button",className:`radio-lobby-card${b?" is-active":""}`,onClick:()=>S(o.id),"aria-pressed":b,children:[e.jsx("span",{className:"radio-lobby-card-icon","aria-hidden":"true",children:e.jsx(u,{name:o.icon,size:18})}),e.jsxs("span",{className:"radio-lobby-card-body",children:[e.jsx("span",{className:"radio-lobby-card-title",children:r(o.labelKey)}),e.jsx("span",{className:"radio-lobby-card-sub",children:E(o.count)})]})]},o.id)})})}),k.length>0&&e.jsx("section",{className:"radio-lobby-section","aria-label":r("filters"),children:e.jsxs("div",{className:"radio-lobby-filters",children:[e.jsx("span",{className:"radio-lobby-filters-label",children:r("filters")}),e.jsxs("div",{className:"radio-lobby-filter-chips",role:"group",children:[e.jsx("button",{type:"button",className:`radio-lobby-filter${l.length===0?" is-active":""}`,onClick:M,"aria-pressed":l.length===0,children:r("filter_all")}),k.map(o=>{const b=l.includes(o);return e.jsx("button",{type:"button",className:`radio-lobby-filter${b?" is-active":""}`,onClick:()=>T(o),"aria-pressed":b,children:C(o,r)},o)})]})]})}),e.jsxs("section",{className:"radio-lobby-section","aria-label":r(j.labelKey),children:[e.jsxs("div",{className:"radio-lobby-list-head",children:[e.jsx("h2",{className:"radio-lobby-list-title",children:r(j.labelKey)}),e.jsxs("button",{type:"button",className:"radio-lobby-play-all",onClick:()=>void _(),disabled:!m||x.length===0,children:[e.jsx(u,{name:"Play",size:14}),r("play_all")]})]}),e.jsx("ul",{className:"radio-lobby-tracks",role:"listbox",children:x.map((o,b)=>{const p=n===o.id,v=p&&s,N=H(o,r);return e.jsx("li",{children:e.jsxs("button",{type:"button",role:"option","aria-selected":p,className:`radio-lobby-row${p?" is-selected":""}`,onClick:()=>void R(o.id),children:[e.jsx("span",{className:"radio-lobby-row-idx","aria-hidden":"true",children:v?e.jsx(u,{name:"Volume2",size:14}):b+1}),e.jsx("span",{className:"radio-lobby-row-icon","aria-hidden":"true",children:e.jsx(u,{name:o.icon,size:18})}),e.jsxs("span",{className:"radio-lobby-row-meta",children:[e.jsx("span",{className:"radio-lobby-row-title",children:Y(o,r)}),N&&e.jsx("span",{className:"radio-lobby-row-sub",children:N})]}),p&&e.jsx("span",{className:"radio-lobby-row-now",children:r("now_playing")})]})},o.id)})})]}),e.jsx("style",{children:`
        .radio-lobby {
          --rl-ink: #12141c;
          --rl-muted: #5b6072;
          max-width: 920px;
